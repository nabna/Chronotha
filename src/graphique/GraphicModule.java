/*
 * Created by JFormDesigner on Thu May 14 21:42:37 CEST 2015
 */
...
public class GraphicModule extends JPanel {
	...
	public JTextField getTextAbbreviation() {
		return textAbbreviation;
	}

	public JColorChooser getComponentCouleur() {
		return componentCouleur;
	}

	public JTextField getTextNbSeance() {
		return textNbSeance;
	}
	...
	private void initComponents() {
		...
		componentCouleur = new JColorChooser();
		textNbSeance = new JTextField();
		...
		//---- label2 ----
		label2.setText("Abbr\u00e9viation");

		//---- label3 ----
		label3.setText("Couleur");

		//---- label4 ----
		label4.setText("Nombre de s\u00e9ance");
		...
		//---- label6 ----
		label6.setText("Gestionnaire de module");
						...
						.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
							...
							.addGroup(layout.createSequentialGroup()
								...
								.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
									...
									.addComponent(textAbbreviation)
									.addComponent(textNom)
									.addComponent(componentCouleur)
									.addComponent(textNbSeance, GroupLayout.PREFERRED_SIZE, 268, GroupLayout.PREFERRED_SIZE))))
		...
		layout.setVerticalGroup(
			layout.createParallelGroup()
				.addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
					...
					.addGap(23, 23, 23)
					.addGroup(layout.createParallelGroup()
						.addComponent(textAbbreviation, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(label2))
					.addGap(18, 18, 18)
					.addGroup(layout.createParallelGroup()
						.addComponent(componentCouleur, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(label3))
					.addGroup(layout.createParallelGroup()
						.addGroup(layout.createSequentialGroup()
							.addGap(18, 18, 18)
							.addComponent(textNbSeance, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGroup(layout.createSequentialGroup()
							.addGap(21, 21, 21)
							.addComponent(label4)))
					.addGap(58, 58, 58)
	...
	private JColorChooser componentCouleur;
	private JTextField textNbSeance;
